...
import de.niklas.tutorialmod.block.custom.HoneyBerryBushBlock;
import de.niklas.tutorialmod.block.custom.KohlrabiCropBlock;
...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        trapdoorBlockWithRenderType(ModBlocks.ALEXANDRITE_TRAP_DOOR.get(), modLoc("block/alexandrite_trap_door"), true, "cutout");
